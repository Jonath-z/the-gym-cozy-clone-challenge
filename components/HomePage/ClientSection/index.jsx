      ...
      <div className="py-16">
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 md:grid-rows-2 gap-10 md:gap-5 px-5 mt-20 relative">
            ...
            <div className="bg-primary-blue shadow-2xl shadow-primary-blue bg-grain bg-grain-size text-right flex flex-col gap-4 pr-10 pl-16 py-20 rounded-tr-8/10 rounded-tl-8/10 rounded-bl-1/1 md:h-fit md:mt-auto">
              ...
              <div>
                ...
                <p className="text-hero-text opacity-70 font-poppins text-12 leading-4 mt-1">
                  Now: Leadership Recruiting @ Product Design at <br /> Facebook
                </p>
              </div>
            </div>
            {/* ------------------------------------------------------ */}
            <div className="bg-card-slate shadow-2xl shadow-card-slate bg-grain bg-grain-size text-left flex flex-col gap-4 pr-10 pl-16 py-20 rounded-tr-1/1 rounded-tl-1/1 rounded-br-5/10">
              <Image
            ...
            {/* --------------------------------------------------------- */}
            <div className="bg-secondary-chocolate shadow-2xl shadow-secondary-chocolate bg-grain bg-grain-size text-right flex flex-col gap-4 pr-10 pl-16 py-20 rounded-tl-1/1 rounded-br-6/10 rounded-bl-6/10 md:h-fit md:mb-auto">
              <Image
